...
let data = [
    ...
    },
    {
        ...
        disc : "Backend for Cemetery/Columbarium CMS Platform (Email for Test Admin Credentials). Scalable for numerous frontends (organization), offers remote access to data (organization settings, security, and records), and provides insights into system uptime/status, and database analytics.",
