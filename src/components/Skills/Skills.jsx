  ...
  return (
    <Container id="skills">
      ...
      <Slide direction="left" id="tools">
            <p>Ruby on Rails | Salesforce Development | Javascript | JQuery | Node | React | HTML | CSS | Bootstrap | PostgreSQL | MySQL | MongoDB | Github | Bitbucket | Heroku | Digital Ocean | Jira | Agile </p>
      </Slide>
        <IconGrid>
